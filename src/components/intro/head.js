...
export const Head = ({page, setPage}) => {
    ...
    return (
        <Flex width='100%' height={isMobile ? "90vh" : "100vh"} align="center" justify="center" style={{position: 'fixed', top: position, opacity: page === 0 ? 1 : 0, overflow: 'hidden', transition: 'opacity 1s'}}>
