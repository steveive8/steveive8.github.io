...
import { Flex, Image, Row, Text } from '../common/plain';
...
const positioner = (x, arg) => {
    return x ? centerX + arg * 2 : centerY + arg * 2
}
...
export const ContributeMap = ({categoryOn, page}) => {
    const circles = [
        {
            text: "#Blockchain",
            x: !isMobile ? centerX + Width / 5 : positioner(true, Width / 5),
        ...
        {
            text: "#React.js",
            x: !isMobile ? centerX - Width / 3 : positioner(true, - Width / 3),
        ...
        {
            text: "#RNN",
            x: !isMobile ? centerX - Width / 3.8 : positioner(true, - Width / 3.8),
            y: !isMobile ? centerY - Height / 20 : positioner(false, - Height / 20),
            size: 150,
            top: false,
            textsize: 20,
            ...
            bg: 'rgba(75,75,75,0.75)',        },
        {
            ...
            x: !isMobile ? centerX : positioner(true, centerX),
            ...
            bg: 'rgba(75,75,75,0.75)',        },
        {
            ...
            x: !isMobile ? centerX - Width / 20 : positioner(true, - Width / 20),
        ...
        {
            text: "#GraphQL",
            x: !isMobile ? centerX - Width / 7 : positioner(true,- Width / 7 ),
            y: !isMobile ? centerY - Height / 20 : positioner(false, - Height / 20),
            size: 150,
            top: false,
            textsize: 20,
    ...
    return (
        <Row width="100%" height={'500px'} style={{transform: isMobile && 'scale(0.7)'}}>
            <Text weight="700" size="30" style={{position: 'absolute', top: 145, left: Width / 20}}>Contribute Map</Text>
            <Flex style={{left: categoryOn ? '15%' : '10.8%', position: 'relative', width: '100%', transform: categoryOn && !isMobile && 'scale(0.8)', transition: 'all 300ms'}}>
                <CircleBox page={page === 2 ? 1 : 0} circles={circles} height={'100%'} />
            </Flex>
            <Image style={{width: '25%', position: 'relative', right: '3%', marginTop: 20}} src="https://github-readme-stats.vercel.app/api/top-langs/?username=johnsteve108&theme=dark&langs_count=8)](https://github.com/johnsteve108/github-readme-stats)" />
        </Row>
    )
};
