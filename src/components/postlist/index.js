...
import { Col, Link, Row, Text, Flex } from '../common/plain';
import Box from './box';
import Post from '../post';
import {ListViewIcon, BoxViewIcon} from '../../icons/view';

export const Content = ({page, contents, on}) => {
    ...
    return (
        <Col width="100%" height="100%" position="fixed" zIndex={100} bg="rgb(3,5,8)" padding="padding: 100px 16%;" style={{overflow: 'scroll', top: on ? 0 : '100%', opacity: on ? 1 : 0, transition: 'all 300ms ease-in-out'}}>
