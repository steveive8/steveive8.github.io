...
import {Col, Row, Text, Flex} from '../common/plain';

export const Post = ({title, content, date, listview}) => {
    return (
        <Col width={listview ? '95.8%' : "100%"} padding={!listview && "padding: 100px 15%"} margin={listview && 'margin: 20px;'} height={"100%"} style={{maxHeight: listview ? 400 : 'auto'}} bg="rgb(3,5,8)">
