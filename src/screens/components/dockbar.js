...
export const DockBar = ({selector, setPage}) => {
        ...
        <Col zIndex={1000} position="fixed" width="80vw" margin="margin: 0px 10vw" height="80px;" align="center" justify="flex-end" style={{bottom: 0, transition: 'all 500ms'}}>
            <Col width="100%" align="center" justify="center">
                <Row width="90%" align="flex-end" justify="space-around" position="absolute" style={{bottom: 10}} zIndex={100000}>
                    <Icon func={setPage} arg={3} title="Home" src={<SteveIve height="100%" />} />
                    <Icon func={selector} title="A.I" src={<AI height="100%" />} />
                    <Icon func={selector} title="Blockchain" src={<Blockchain height="100%" />} />
                    <Icon func={selector} title="Relativity" src={<Relativity height="100%" />} />
                    <Icon func={selector} title="Quantaum" src={<Quantaum height="100%" />} />
                    <Icon func={selector} title="Develop" src={<Dev height="100%" />} />
                    <a href="https://www.github.com/steveive8">
                        <Icon title="Github" src={<Image height="60%" src={Github} />} />
                    </a>
                    <Icon func={selector} title="About Me" src={<Image src={Buddha} height="60%" />} />
                </Row>
...
export const Icon = ({src, title, func, arg}) => {
    const [hover, setHover] = useState(false);
    return (
        <Col onClick={() => func(arg ? arg : title)} onMouseOver={() => setHover(true)} onMouseOut={() => setHover(false)} style={{overflow: 'hidden'}} to="cursor" align="center" width="125px" justify="flex-end" height={hover ? "72px" : "65px"} zIndex={100000}>
            {src}
